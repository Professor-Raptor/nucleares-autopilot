...
## Install 
- [nucleares.exe](https://github.com/Professor-Raptor/nucleares-autopilot/releases/download/v0.2.0/nucleares.exe)  -- Windows standalone binary  
- [nucleares.py](https://github.com/Professor-Raptor/nucleares-autopilot/releases/download/v0.2.0/nucleares.py)  -- Python script file (requires dependencies)
...
The script was designed around using five fuel cells, although it seems to work okay with one. If you are using more than five, I imagine at some point you will need to tweak the core control logic (specifically, consider changing +6 and +2 to higher numbers).  
...
In the UI, each header/subheader will be colored cyan or green to indicate if control is enabled for that system.  
